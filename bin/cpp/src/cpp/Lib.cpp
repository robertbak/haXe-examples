...
Dynamic Lib_obj::load( ::String lib,::String prim,int nargs){
	...
	HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/Lib.hx",32)
...
Dynamic Lib_obj::loadLazy( Dynamic lib,Dynamic prim,int nargs){
	...
	HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/Lib.hx",44)
	try{
		HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/Lib.hx",45)
		return ::__loadprim(lib,prim,nargs);
	}
	catch(Dynamic __e){
		{
			Dynamic e = __e;{
				HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/Lib.hx",47)
				...
				switch( (int)(nargs)){
					case (int)0: {
						...
						Void run(){
{
								HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/Lib.hx",49)
...
{
								HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/Lib.hx",50)
								hx::Throw (e1->__GetItem((int)0));
							}
							return null();
						}
...
{
								HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/Lib.hx",51)
								hx::Throw (e1->__GetItem((int)0));
							}
							return null();
						}
...
{
								HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/Lib.hx",52)
								hx::Throw (e1->__GetItem((int)0));
							}
							return null();
						}
...
{
								HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/Lib.hx",53)
								hx::Throw (e1->__GetItem((int)0));
							}
							return null();
						}
					...
					default: {
						...
						Void run(Dynamic _1){
{
								HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/Lib.hx",54)
								hx::Throw (e1->__GetItem((int)0));
							}
							return null();
						}
...
Void Lib_obj::rethrow( Dynamic inExp){
{
		...
		HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/Lib.hx",59)
		hx::Throw (inExp);
	}
return null();
}
...
Void Lib_obj::stringReference( Dynamic inExp){
{
		...
		HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/Lib.hx",61)
		hx::Throw (inExp);
	}
return null();
}
...
Void Lib_obj::print( Dynamic v){
{
		...
		HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/Lib.hx",66)
		::__hxcpp_print(v);
	}
return null();
}
...
Dynamic Lib_obj::haxeToNeko( Dynamic v){
	...
	HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/Lib.hx",74)
	return v;
}
...
Dynamic Lib_obj::nekoToHaxe( Dynamic v){
	...
	HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/Lib.hx",82)
	return v;
}
...
Void Lib_obj::println( Dynamic v){
{
		...
		HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/Lib.hx",88)
		::__hxcpp_println(v);
	}
return null();
}
