...
{
{
	HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/StringBuf.hx",35)
...
Void StringBuf_obj::add( Dynamic x){
{
		...
		HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/StringBuf.hx",46)
...
Void StringBuf_obj::addSub( ::String s,int pos,Dynamic len){
{
		...
		HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/StringBuf.hx",59)
...
Void StringBuf_obj::addChar( int c){
{
		...
		HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/StringBuf.hx",75)
...
::String StringBuf_obj::toString( ){
	...
	HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/StringBuf.hx",89)
