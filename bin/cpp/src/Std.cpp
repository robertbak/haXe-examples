...
bool Std_obj::is( Dynamic v,Dynamic t){
	...
	HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/_std/Std.hx",27)
...
::String Std_obj::string( Dynamic s){
	...
	HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/_std/Std.hx",31)
...
int Std_obj::_int( double x){
	...
	HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/_std/Std.hx",35)
	return ::__int__(x);
}
...
Dynamic Std_obj::parseInt( ::String x){
	...
	HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/_std/Std.hx",39)
...
double Std_obj::parseFloat( ::String x){
	...
	HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/_std/Std.hx",43)
...
int Std_obj::random( int x){
	...
	HX_SOURCE_POS("H:\\Programy\\FDT\\haXe\\haxe-2.08-win\\std/cpp/_std/Std.hx",47)
